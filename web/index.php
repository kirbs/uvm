	...
	while($PFSmere = mysql_fetch_array($req_liste_pfs_mere))
	{
		...
		while($PFSfille = mysql_fetch_array($req_liste_pfs_fille))
		{
			...
			while ($UvmByPFSfille = mysql_fetch_array($req_UvmByPFSfille))
			{
			    ...
			    echo "<tr bgcolor='#FFC700'; onmouseover=this.bgColor='#FFAC38'; onmouseout=this.bgColor='#FFC700'; data-tt-id='$cpt_pfs_mere.$cpt_pfs_fille' data-tt-parent-id='$cpt_pfs_mere'>";
			...
			{
				echo "<tr bgcolor='#FFC700'; onmouseover=this.bgColor='#FFAC38'; onmouseout=this.bgColor='#FFC700'; data-tt-id='$cpt_pfs_mere.$cpt_pfs_fille.$cpt_vm' data-tt-parent-id='$cpt_pfs_mere.$cpt_pfs_fille'>";
