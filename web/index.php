...
function formulaire($today)
{
	...
	<table width='100%' border=1>
		<tr>
			<td width='50%' align='center'><div id='population'></div></td>
			<td width='50%' align='center' ><div id='graphUvmByAllSite' style='min-width: 700px; height: 400px; margin: 0 auto'></div></td>
		</tr>
		<tr>
