...
function formulaire($today)
{
	...
	<table width='100%' border=1>
		<tr>
			<td span='2' align='center'>ddd<div id='population' style='align: center'></div></td>
		</tr>
		<tr>
			<td width='33%' align='center' ><div id='graphUvmByAllSite' style='min-width: 650px; height: 400px; margin: 0 auto'></div></td>
			<td width='33%' align='center' ><div id='graphVMByAllSite' style='min-width: 650px; height: 400px; margin: 0 auto'></div></td>
		</tr>
		<tr>
