...
function TreeTable_uvm_by_pfs_mere($date)
{
	...
	while($PFSmere = mysql_fetch_array($req_liste_pfs_mere))
	{
		...
		echo "<tr bgcolor='#82D7FF'; onmouseover=this.bgColor='#56FFFF'; onmouseout=this.bgColor='#82D7FF'; data-tt-id='$cpt_pfs_mere'>";
		...
		while($PFSfille = mysql_fetch_array($req_liste_pfs_fille))
		{
			...
			while ($UvmByPFSfille = mysql_fetch_array($req_UvmByPFSfille))
			{
			    ...
			    echo "<tr bgcolor='#82D700'; onmouseover=this.bgColor='#56FFFF'; onmouseout=this.bgColor='#82D700'; data-tt-id='$cpt_pfs_mere.$cpt_pfs_fille' data-tt-parent-id='$cpt_pfs_mere'>";
			...
			{
				echo "<tr bgcolor='#82D000'; onmouseover=this.bgColor='#56FFFF'; onmouseout=this.bgColor='#82D000'; data-tt-id='$cpt_pfs_mere.$cpt_pfs_fille.$cpt_vm' data-tt-parent-id='$cpt_pfs_mere.$cpt_pfs_fille'>";
