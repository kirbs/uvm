			        ...
			        chart = new Highcharts.Chart({
			            ...
			            tooltip: {
			                formatter: function() {
				                ...
				                s += '<br/><br/>uMem total: '+ var_umem_total +' <i>('+ (var_umem_total / 2) +'Go)</i>'+
				                '<br/>uMem utilisées : '+ var_umem_used +' <i>('+ (var_umem_used / 2) +'Go)</i>'+
				                '<br/><b>uMem dispo : '+ var_umem_dispo +' <i>('+ (var_umem_dispo / 2) +'Go)</i></b>'+
				                '<br/><br/>uCpu total: '+ var_ucpu_total +' <i>('+ (var_ucpu_total / 2) +'Go)</i>'+
				                '<br/>uCpu utilisées : '+ var_ucpu_used +' <i>('+ (var_ucpu_used / 2) +'Go)</i>'+
				                '<br/><b>uCpu dispo : '+ var_ucpu_dispo +' <i>('+ (var_ucpu_dispo / 2) +'Go)</i></b>';
